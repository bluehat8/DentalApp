...
namespace DentalApp.Services.AsistenteServices
{
    public class AsistenteServices
    {
        ...
        public AsistenteServices(ApiClient apiClient)
        {
        ...
        public async Task<Asistente?> ObtenerAsistenteAsync(int id)
        {
            try
            {
                var apiUrl = Constants.apiUrl + $"/api/Asistente/{id}";
                ...
                using (HttpClient httpClient = new HttpClient())
                {
                    ...
                    if (response.IsSuccessStatusCode)
                    {
                        ...
                        var _Asistente = JsonConvert.DeserializeObject<Asistente>(jsonResponse);
